  ...
  return (
    <div className="container homeHero">
      <div className="position-relative d-flex">
        <img
          className="imgHomeHero"
          src="https://micasa10.com/wp-content/uploads/comprar-muebles-online-para-salon.jpg"
          alt=""
        />
        <div className="position-absolute justify-content-center dataHomeHero">
          <div>
            <h2 className="homeTitle">Mejora tu hogar en un click</h2>
          </div>
          <div className="buttonHome">
            <Link to="/productos" className="buttonCount2">
              Ver Productos
            </Link>
          </div>
        </div>

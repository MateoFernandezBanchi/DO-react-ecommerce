  ...
  return (
        <div className='navContainer'>
          ...
          <nav className="navbar navbar-expand-lg navbar-light  d-flexCenter">
            <button style={{margin:'0 auto'}}  className="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <Link to='/home'> <li className="nav-item nav-link">Inicio</li></Link>
